...
<div class="bg-[#2E2E2E] relative">
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between py-4">
      <h1 class="text-2xl text-white font-normal">Gateways</h1>
      <div class="flex items-center gap-4">
        <div class="relative">
          <Input
            type="search"
            placeholder="Search"
            class="w-[400px] bg-[#1E1E1E] border-0 text-white placeholder:text-gray-400 pl-10"
        ...
        <Button
          variant="outline"
          size="icon"
          class="rounded-full bg-white/10 hover:bg-white/20 w-10 h-10"
      ...
      <tbody>
        {#each filteredGateways as gateway}
          <tr class="border-b border-gray-100 hover:bg-gray-50">
            <td class="py-3 px-4">
              <div class="flex items-center gap-2 cursor-pointer" on:click={() => navigateToGateway(gateway.location)}>
            ...
            <td class="py-3 px-4">
              <div class="flex flex-wrap gap-2">
                {#each gateway.domains as domain}
                  <span class="px-2 py-1 bg-gray-50 rounded text-sm text-gray-900">
                    {domain}
                  </span>
                {/each}
              </div>
